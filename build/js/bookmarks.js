...
(function() {
  ...
  OneBookmarkItem = (function(_super) {
    ...
    function OneBookmarkItem() {
      ...
      this.removeItem = __bind(this.removeItem, this);      return OneBookmarkItem.__super__.constructor.apply(this, arguments);
    }
  ...
  ManyBookmarks = (function(_super) {
    ...
    function ManyBookmarks() {
      ...
      this.addOne = __bind(this.addOne, this);      return ManyBookmarks.__super__.constructor.apply(this, arguments);
    }
  ...
  exports.View = View = (function(_super) {
    ...
    function View() {
      this.initialize = __bind(this.initialize, this);      return View.__super__.constructor.apply(this, arguments);
    }
