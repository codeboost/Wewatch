...
(function() {
  ...
  RighSide = (function(_super) {
    ...
    function RighSide() {
      ...
      this.selectBookmarks = __bind(this.selectBookmarks, this);      return RighSide.__super__.constructor.apply(this, arguments);
    }
  ...
  VideoInfo = (function(_super) {
    ...
    function VideoInfo() {
      ...
      this.updateViewers = __bind(this.updateViewers, this);      return VideoInfo.__super__.constructor.apply(this, arguments);
    }
    ...
    VideoInfo.prototype.update = function() {
      var presenter, ret, viewCount, _ref1, _ref2;
      if (WWM.isModerator) {
        ...
        presenter = (_ref1 = ret != null ? (_ref2 = ret[0]) != null ? _ref2.get('name') : void 0 : void 0) != null ? _ref1 : 'No one';
  ...
  ConnectionView = (function(_super) {
    ...
    function ConnectionView() {
      this.update = __bind(this.update, this);      return ConnectionView.__super__.constructor.apply(this, arguments);
    }
  ...
  window.onYouTubePlayerAPIReady = function() {
    ...
    WWM.conn.bind('joined', function(bootstrap) {
      ...
      if ((_ref1 = WWM.user.name) != null ? _ref1.length : void 0) {
