...
(function(/*! Stitch !*/) {
  ...
  var Skull, UserCollection, VideoModel, VideoView, connectToServer, extractVideoId, insertIframe, insertPlayer, saveVideoState,
  ...
  connectToServer = function() {
    ...
    sio.on('connect', function() {
      ...
      return sio.emit('join', WWM.session.id, function(err, data) {
        var globalNS, updateViewers, videoView;
