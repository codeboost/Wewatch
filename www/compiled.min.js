...
a){this.clearCloseTimeout(),(this.connected||this.connecting||this.reconnecting)&&this.setCloseTimeout();if(a!==""){var c=b.parser.decodePayload(a);if(c&&c.length)for(var d=0,e=c.length;d<e;d++)this.onPacket(c[d])}return this},c.prototype.onPacket=function(a){return a.type=="heartbeat"?this.onHeartbeat():(a.type=="connect"&&a.endpoint==""&&this.onConnect(),this.socket.onPacket(a),this)},c.prototype.setCloseTimeout=function(){if(!this.closeTimeout){var a=this;this.closeTimeout=setTimeout(function(){a.onDisconnect()},this.socket.closeTimeout)}},c.prototype.onDisconnect=function(){return this.close&&this.open&&this.close(),this.clearTimeouts(),this.socket.onDisconnect(),this},c.prototype.onConnect=function(){return this.socket.onConnect(),this},c.prototype.clearCloseTimeout=function(){this.closeTimeout&&(clearTimeout(this.closeTimeout),this.closeTimeout=null)},c.prototype.clearTimeouts=function(){this.clearCloseTimeout(),this.reopenTimeout&&clearTimeout(this.reopenTimeout)},c.prototype.packet=function(a){this.send(b.parser.encodePacket(a))},c.prototype.onHeartbeat=function(a){this.packet({type:"heartbeat"})},c.prototype.onOpen=function(){this.open=!0,this.clearCloseTimeout(),this.socket.onOpen()},c.prototype.onClose=function(){var a=this;this.open=!1,this.socket.onClose(),this.onDisconnect()},c.prototype.prepareUrl=function(){var a=this.socket.options;return this.scheme()+"://"+a.host+":"+a.port+"/"+a.resource+"/"+b.protocol+"/"+this.name+"/"+this.sessid},c.prototype.ready=function(a,b){b.call(this)}}("undefined"!=typeof io?io:module.exports,"undefined"!=typeof io?io:module.parent.exports),function(a,b,c){function d(a){this.options={port:80,secure:!1,document:"document"in c?document:!1,resource:"socket.io",transports:b.transports,"connect timeout":1e4,"try multiple transports":!0,reconnect:!0,"reconnection delay":500,"reconnection limit":Infinity,"reopen delay":3e3,"max reconnection attempts":10,"sync disconnect on unload":!0,"auto connect":!0,"flash policy port":10843},b.util.merge(this.options,a),this.connected=!1,this.open=!1,this.connecting=!1,this.reconnecting=!1,this.namespaces={},this.buffer=[],this.doBuffer=!1;if(this.options["sync disconnect on unload"]&&(!this.isXDomain()||b.util.ua.hasCORS)){var d=this;b.util.on(c,"beforeunload",function(){d.disconnectSync()},!1)}this.options["auto connect"]&&this.connect()}function e(){}a.Socket=d,b.util.mixin(d,b.EventEmitter),d.prototype.of=function(a){return this.namespaces[a]||(this.namespaces[a]=new b.SocketNamespace(this,a),a!==""&&this.namespaces[a].packet({type:"connect"})),this.namespaces[a]},d.prototype.publish=function(){this.emit.apply(this,arguments);var a;for(var b in this.namespaces)this.namespaces.hasOwnProperty(b)&&(a=this.of(b),a.$emit.apply(a,arguments))},d.prototype.handshake=function(a){function f(b){b instanceof Error?c.onError(b.message):a.apply(null,b.split(":"))}var c=this,d=this.options,g=["http"+(d.secure?"s":"")+":/",d.host+":"+d.port,d.resource,b.protocol,b.util.query(this.options.query,"t="+ +(new Date))].join("/");if(this.isXDomain()&&!b.util.ua.hasCORS){var h=document.getElementsByTagName("script")[0],i=document.createElement("script");i.src=g+"&jsonp="+b.j.length,h.parentNode.insertBefore(i,h),b.j.push(function(a){f(a),i.parentNode.removeChild(i)})}else{var j=b.util.request();j.open("GET",g,!0),j.onreadystatechange=function(){j.readyState==4&&(j.onreadystatechange=e,j.status==200?f(j.responseText):!c.reconnecting&&c.onError(j.responseText))},j.send(null)}},d.prototype.getTransport=function(a){var c=a||this.transports,d;for(var e=0,f;f=c[e];e++)if(b.Transport[f]&&b.Transport[f].check(this)&&(!this.isXDomain()||b.Transport[f].xdomainCheck()))return new b.Transport[f](this,this.sessionid);return null},d.prototype.connect=function(a){if(this.connecting)return this;var c=this;return this.handshake(function(d,e,f,g){function h(a){c.transport&&c.transport.clearTimeouts(),c.transport=c.getTransport(a);if(!c.transport)return c.publish("connect_failed");c.transport.ready(c,function(){c.connecting=!0,c.publish("connecting",c.transport.name),c.transport.open(),c.options["connect timeout"]&&(c.connectTimeoutTimer=setTimeout(function(){if(!c.connected){c.connecting=!1;if(c.options["try multiple transports"]){c.remainingTransports||(c.remainingTransports=c.transports.slice(0));var a=c.remainingTransports;while(a.length>0&&a.splice(0,1)[0]!=c.transport.name);a.length?h(a):c.publish("connect_failed")}}},c.options["connect timeout"]))})}c.sessionid=d,c.closeTimeout=f*1e3,c.heartbeatTimeout=e*1e3,c.transports=b.util.intersect(g.split(","),c.options.transports),h(),c.once("connect",function(){clearTimeout(c.connectTimeoutTimer),a&&typeof a=="function"&&a()})}),this},d.prototype.packet=function(a){return this.connected&&!this.doBuffer?this.transport.packet(a):this.buffer.push(a),this},d.prototype.setBuffer=function(a){this.doBuffer=a,!a&&this.connected&&this.buffer.length&&(this.transport.payload(this.buffer),this.buffer=[])},d.prototype.disconnect=function(){return this.connected&&(this.open&&this.of("").packet({type:"disconnect"}),this.onDisconnect("booted")),this},d.prototype.disconnectSync=function(){var a=b.util.request(),c=this.resource+"/"+b.protocol+"/"+this.sessionid;a.open("GET",c,!0),this.onDisconnect("booted")},d.prototype.isXDomain=function(){var a=c.location.port||("https:"==c.location.protocol?443:80);return this.options.host!==c.location.hostname||this.options.port!=a},d.prototype.onConnect=function(){this.connected||(this.connected=!0,this.connecting=!1,this.doBuffer||this.setBuffer(!1),this.emit("connect"))},d.prototype.onOpen=function(){this.open=!0},d.prototype.onClose=function(){this.open=!1},d.prototype.onPacket=function(a){this.of(a.endpoint).onPacket(a)},d.prototype.onError=function(a){a&&a.advice&&a.advice==="reconnect"&&this.connected&&(this.disconnect(),this.reconnect()),this.publish("error",a&&a.reason?a.reason:a)},d.prototype.onDisconnect=function(a){var b=this.connected;this.connected=!1,this.connecting=!1,this.open=!1,b&&(this.transport.close(),this.transport.clearTimeouts(),this.publish("disconnect",a),"booted"!=a&&this.options.reconnect&&!this.reconnecting&&this.reconnect())},d.prototype.reconnect=function(){function e(){if(a.connected){for(var b in a.namespaces)a.namespaces.hasOwnProperty(b)&&""!==b&&a.namespaces[b].packet({type:"connect"});a.publish("reconnect",a.transport.name,a.reconnectionAttempts)}a.removeListener("connect_failed",f),a.removeListener("connect",f),a.reconnecting=!1,delete a.reconnectionAttempts,delete a.reconnectionDelay,delete a.reconnectionTimer,delete a.redoTransports,a.options["try multiple transports"]=c}function f(){if(!a.reconnecting)return;if(a.connected)return e();if(a.connecting&&a.reconnecting)return a.reconnectionTimer=setTimeout(f,1e3);a.reconnectionAttempts++>=b?a.redoTransports?(a.publish("reconnect_failed"),e()):(a.on("connect_failed",f),a.options["try multiple transports"]=!0,a.transport=a.getTransport(),a.redoTransports=!0,a.connect()):(a.reconnectionDelay<d&&(a.reconnectionDelay*=2),a.connect(),a.publish("reconnecting",a.reconnectionDelay,a.reconnectionAttempts),a.reconnectionTimer=setTimeout(f,a.reconnectionDelay))}this.reconnecting=!0,this.reconnectionAttempts=0,this.reconnectionDelay=this.options["reconnection delay"];var a=this,b=this.options["max reconnection attempts"],c=this.options["try multiple transports"],d=this.options["reconnection limit"];this.options["try multiple transports"]=!1,this.reconnectionTimer=setTimeout(f,this.reconnectionDelay),this.on("connect",f)}}("undefined"!=typeof io?io:module.exports,"undefined"!=typeof io?io:module.parent.exports,this),function(a,b){function c(a,b){this.socket=a,this.name=b||"",this.flags={},this.json=new d(this,"json"),this.ackPackets=0,this.acks={}}function d(a,b){this.namespace=a,this.name=b}a.SocketNamespace=c,b.util.mixin(c,b.EventEmitter),c.prototype.$emit=b.EventEmitter.prototype.emit,c.prototype.of=function(){return this.socket.of.apply(this.socket,arguments)},c.prototype.packet=function(a){return a.endpoint=this.name,this.socket.packet(a),this.flags={},this},c.prototype.send=function(a,b){var c={type:this.flags.json?"json":"message",data:a};return"function"==typeof b&&(c.id=++this.ackPackets,c.ack=!0,this.acks[c.id]=b),this.packet(c)},c.prototype.emit=function(a){var b=Array.prototype.slice.call(arguments,1),c=b[b.length-1],d={type:"event",name:a};return"function"==typeof c&&(d.id=++this.ackPackets,d.ack="data",this.acks[d.id]=c,b=b.slice(0,b.length-1)),d.args=b,this.packet(d)},c.prototype.disconnect=function(){return this.name===""?this.socket.disconnect():(this.packet({type:"disconnect"}),this.$emit("disconnect")),this},c.prototype.onPacket=function(a){function d(){c.packet({type:"ack",args:b.util.toArray(arguments),ackId:a.id})}var c=this;switch(a.type){case"connect":this.$emit("connect");break;case"disconnect":this.name===""?this.socket.onDisconnect(a.reason||"booted"):this.$emit("disconnect",a.reason);break;case"message":case"json":var e=["message",a.data];a.ack=="data"?e.push(d):a.ack&&this.packet({type:"ack",ackId:a.id}),this.$emit.apply(this,e);break;case"event":var e=[a.name].concat(a.args);a.ack=="data"&&e.push(d),this.$emit.apply(this,e);break;case"ack":this.acks[a.ackId]&&(this.acks[a.ackId].apply(this,a.args),delete this.acks[a.ackId]);break;case"error":a.advice?this.socket.onError(a):a.reason=="unauthorized"?this.$emit("connect_failed",a.reason):this.$emit("error",a.reason)}},d.prototype.send=function(){this.namespace.flags[this.name]=!0,this.namespace.send.apply(this.namespace,arguments)},d.prototype.emit=function(){this.namespace.flags[this.name]=!0,this.namespace.emit.apply(this.namespace,arguments)}}("undefined"!=typeof io?io:module.exports,"undefined"!=typeof io?io:module.parent.exports),function(a,b,c){function d(a){b.Transport.apply(this,arguments)}a.websocket=d,b.util.inherit(d,b.Transport),d.prototype.name="websocket",d.prototype.open=function(){var a=b.util.query(this.socket.options.query),d=this,e;return e||(e=c.MozWebSocket||c.WebSocket),this.websocket=new e(this.prepareUrl()+a),this.websocket.onopen=function(){d.onOpen(),d.socket.setBuffer(!1)},this.websocket.onmessage=function(a){d.onData(a.data)},this.websocket.onclose=function(){d.onClose(),d.socket.setBuffer(!0)},this.websocket.onerror=function(a){d.onError(a)},this},d.prototype.send=function(a){return this.websocket.send(a),this},d.prototype.payload=function(a){for(var b=0,c=a.length;b<c;b++)this.packet(a[b]);return this},d.prototype.close=function(){return this.websocket.close(),this},d.prototype.onError=function(a){this.socket.onError(a)},d.prototype.scheme=function(){return this.socket.options.secure?"wss":"ws"},d.check=function(){return"WebSocket"in c&&!("__addTask"in WebSocket)||"MozWebSocket"in c},d.xdomainCheck=function(){return!0},b.transports.push("websocket")}("undefined"!=typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports,this),function(a,b,c){function d(a){if(!a)return;b.Transport.apply(this,arguments),this.sendBuffer=[]}function e(){}a.XHR=d,b.util.inherit(d,b.Transport),d.prototype.open=function(){return this.socket.setBuffer(!1),this.onOpen(),this.get(),this.setCloseTimeout(),this},d.prototype.payload=function(a){var c=[];for(var d=0,e=a.length;d<e;d++)c.push(b.parser.encodePacket(a[d]));this.send(b.parser.encodePayload(c))},d.prototype.send=function(a){return this.post(a),this},d.prototype.post=function(a){function d(){this.readyState==4&&(this.onreadystatechange=e,b.posting=!1,this.status==200?b.socket.setBuffer(!1):b.onClose())}function f(){this.onload=e,b.socket.setBuffer(!1)}var b=this;this.socket.setBuffer(!0),this.sendXHR=this.request("POST"),c.XDomainRequest&&this.sendXHR instanceof XDomainRequest?this.sendXHR.onload=this.sendXHR.onerror=f:this.sendXHR.onreadystatechange=d,this.sendXHR.send(a)},d.prototype.close=function(){return this.onClose(),this},d.prototype.request=function(a){var c=b.util.request(this.socket.isXDomain()),d=b.util.query(this.socket.options.query,"t="+ +(new Date));c.open(a||"GET",this.prepareUrl()+d,!0);if(a=="POST")try{c.setRequestHeader?c.setRequestHeader("Content-type","text/plain;charset=UTF-8"):c.contentType="text/plain"}catch(e){}return c},d.prototype.scheme=function(){return this.socket.options.secure?"https":"http"},d.check=function(a,c){try{if(b.util.request(c))return!0}catch(d){}return!1},d.xdomainCheck=function(){return d.check(null,!0)}}("undefined"!=typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports,this),function(a,b){function c(a){b.Transport.XHR.apply(this,arguments)}a.htmlfile=c,b.util.inherit(c,b.Transport.XHR),c.prototype.name="htmlfile",c.prototype.get=function(){this.doc=new ActiveXObject("htmlfile"),this.doc.open(),this.doc.write("<html></html>"),this.doc.close(),this.doc.parentWindow.s=this;var a=this.doc.createElement("div");a.className="socketio",this.doc.body.appendChild(a),this.iframe=this.doc.createElement("iframe"),a.appendChild(this.iframe);var c=this,d=b.util.query(this.socket.options.query,"t="+ +(new Date));this.iframe.src=this.prepareUrl()+d,b.util.on(window,"unload",function(){c.destroy()})},c.prototype._=function(a,b){this.onData(a);try{var c=b.getElementsByTagName("script")[0];c.parentNode.removeChild(c)}catch(d){}},c.prototype.destroy=function(){if(this.iframe){try{this.iframe.src="about:blank"}catch(a){}this.doc=null,this.iframe.parentNode.removeChild(this.iframe),this.iframe=null,CollectGarbage()}},c.prototype.close=function(){return this.destroy(),b.Transport.XHR.prototype.close.call(this)},c.check=function(){if("ActiveXObject"in window)try{var a=new ActiveXObject("htmlfile");return a&&b.Transport.XHR.check()}catch(c){}return!1},c.xdomainCheck=function(){return!1},b.transports.push("htmlfile")}("undefined"!=typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports),function(a,b,c){function d(){b.Transport.XHR.apply(this,arguments)}function e(){}a["xhr-polling"]=d,b.util.inherit(d,b.Transport.XHR),b.util.merge(d,b.Transport.XHR),d.prototype.name="xhr-polling",d.prototype.open=function(){var a=this;return b.Transport.XHR.prototype.open.call(a),!1},d.prototype.get=function(){function b(){this.readyState==4&&(this.onreadystatechange=e,this.status==200?(a.onData(this.responseText),a.get()):a.onClose())}function d(){this.onload=e,a.onData(this.responseText),a.get()}if(!this.open)return;var a=this;this.xhr=this.request(),c.XDomainRequest&&this.xhr instanceof XDomainRequest?this.xhr.onload=this.xhr.onerror=d:this.xhr.onreadystatechange=b,this.xhr.send(null)},d.prototype.onClose=function(){b.Transport.XHR.prototype.onClose.call(this);if(this.xhr){this.xhr.onreadystatechange=this.xhr.onload=e;try{this.xhr.abort()}catch(a){}this.xhr=null}},d.prototype.ready=function(a,c){var d=this;b.util.defer(function(){c.call(d)})},b.transports.push("xhr-polling")}("undefined"!=typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports,this),function(a,b,c){function e(a){b.Transport["xhr-polling"].apply(this,arguments),this.index=b.j.length;var c=this;b.j.push(function(a){c._(a)})}var d=c.document&&"MozAppearance"in c.document.documentElement.style;a["jsonp-polling"]=e,b.util.inherit(e,b.Transport["xhr-polling"]),e.prototype.name="jsonp-polling",e.prototype.post=function(a){function i(){j(),c.socket.setBuffer(!1)}function j(){c.iframe&&c.form.removeChild(c.iframe);try{h=document.createElement('<iframe name="'+c.iframeId+'">')}catch(a){h=document.createElement("iframe"),h.name=c.iframeId}h.id=c.iframeId,c.form.appendChild(h),c.iframe=h}var c=this,d=b.util.query(this.socket.options.query,"t="+ +(new Date)+"&i="+this.index);if(!this.form){var e=document.createElement("form"),f=document.createElement("textarea"),g=this.iframeId="socketio_iframe_"+this.index,h;e.className="socketio",e.style.position="absolute",e.style.top="-1000px",e.style.left="-1000px",e.target=g,e.method="POST",e.setAttribute("accept-charset","utf-8"),f.name="d",e.appendChild(f),document.body.appendChild(e),this.form=e,this.area=f}this.form.action=this.prepareUrl()+d,j(),this.area.value=b.JSON.stringify(a);try{this.form.submit()}catch(k){}this.iframe.attachEvent?h.onreadystatechange=function(){c.iframe.readyState=="complete"&&i()}:this.iframe.onload=i,this.socket.setBuffer(!0)},e.prototype.get=function(){var a=this,c=document.createElement("script"),e=b.util.query(this.socket.options.query,"t="+ +(new Date)+"&i="+this.index);this.script&&(this.script.parentNode.removeChild(this.script),this.script=null),c.async=!0,c.src=this.prepareUrl()+e,c.onerror=function(){a.onClose()};var f=document.getElementsByTagName("script")[0];f.parentNode.insertBefore(c,f),this.script=c,d&&setTimeout(function(){var a=document.createElement("iframe");document.body.appendChild(a),document.body.removeChild(a)},100)},e.prototype._=function(a){return this.onData(a),this.open&&this.get(),this},e.prototype.ready=function(a,c){var e=this;if(!d)return c.call(this);b.util.load(function(){c.call(e)})},e.check=function(){return"document"in c},e.xdomainCheck=function(){return!0},b.transports.push("jsonp-polling")}("undefined"!=typeof io?io.Transport:module.exports,"undefined"!=typeof io?io:module.parent.exports,this),function(a){function b(){}for(var c="assert,count,debug,dir,dirxml,error,exception,group,groupCollapsed,groupEnd,info,log,markTimeline,profile,profileEnd,time,timeEnd,trace,warn".split(","),d;d=c.pop();)a[d]=a[d]||b}(window.console=window.console||{}),function(){if(!this.require){var a={},b={},c=function(f,g){var h=d(g,f),i=b[h],j;if(i)return i.exports;if(!(j=a[h]||a[h=d(h,"./index")]))throw"module '"+f+"' not found";i={id:h,exports:{}};try{return b[h]=i,j(i.exports,function(a){return c(a,e(h))},i),i.exports}catch(k){throw delete b[h],k}},d=function(a,b){var c=[],d,e;/^\.\.?(\/|$)/.test(b)?d=[a,b].join("/").split("/"):d=b.split("/");for(var f=0,g=d.length;f<g;f++)e=d[f],e==".."?c.pop():e!="."&&e!=""&&c.push(e);return c.join("/")},e=function(a){return a.split("/").slice(0,-1).join("/")};this.require=function(a){return c(a,"")},this.require.define=function(b){for(var c in b)a[c]=b[c]}}return this.require.define}.call(this)({app:function(a,b,c){((function(){var c,d,e,f,g,h,i,j,k,l,m,n,o,p,q=function(a,b){return function(){return a.apply(b,arguments)}},r=Object.prototype.hasOwnProperty,s=function(a,b){function d(){this.constructor=a}for(var c in b)r.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};typeof window!="undefined"&&window!==null&&(p=window.module)!=null&&p.enter("app"),n=b("ioState"),i=b("playlist"),h=b("playerView"),g=b("name-dialog"),e=b("chat"),d=b("bookmarks");try{k=b("skull-client")}catch(t){k=b("skull")}WWM.Player=null,WWM.isModerator=WWM.session.creator===WWM.user._id,WWM.initialized=!1,WWM.paused=!1,j=function(a){function b(){this.render=q(this.render,this),this.selectPlaylist=q(this.selectPlaylist,this),this.selectBookmarks=q(this.selectBookmarks,this),b.__super__.constructor.apply(this,arguments)}return s(b,a),b.prototype.events={"click .select-bookmarks":"selectBookmarks","click .select-playlist":"selectPlaylist"},b.prototype.initialize=function(){return this.playlist=new i.View({collection:WWM.models.playlist,el:this.$(".playlist-view")}),this.bookmarks=new d.View({collection:WWM.models.bookmarks,el:this.$(".bookmarks-view")}),this.tabs={bookmarks:this.$(".select-bookmarks"),playlist:this.$(".select-playlist")},this.curView=this.playlist},b.prototype.selectBookmarks=function(a){return a!=null&&a.preventDefault(),this.playlist.$el.hide(),this.bookmarks.$el.show(),this.tabs.bookmarks.addClass("active"),this.tabs.playlist.removeClass("active"),this.curView=this.bookmarks},b.prototype.selectPlaylist=function(a){return a!=null&&a.preventDefault(),this.bookmarks.$el.hide(),this.playlist.$el.show(),this.tabs.bookmarks.removeClass("active"),this.tabs.playlist.addClass("active"),this.curView=this.playlist},b.prototype.render=function(){return this.curView.render()},b}(Backbone.View),l=function(a){function b(){this.update=q(this.update,this),this.updateViewers=q(this.updateViewers,this),b.__super__.constructor.apply(this,arguments)}return s(b,a),b.prototype.initialize=function(){return this.title=this.$(".video-title"),this.viewers=this.$(".viewers"),this.totalViews=this.$(".total-views"),this.model.bind("change",this.update),this.options.usersModel.bind("all",this.updateViewers),this.update(),this.updateViewers()},b.prototype.updateViewers=function(){var a,b,c;return c=this.options.usersModel.length,b=function(a,b){return b.get("idle")?a:a+1},a=this.options.usersModel.reduce(b,0),this.viewers.text(a+"/"+c+" viewers")},b.prototype.update=function(){var a,b,c,d,e;return WWM.isModerator?(this.title.text("You are presenting"),this.$(".search-view").show(),this.$(".right-side").show()):(b=this.options.usersModel.filter(function(a){return WWM.session.creator===a.get("id_user")}),a=(d=b!=null?(e=b[0])!=null?e.get("name"):void 0:void 0)!=null?d:"No one",this.title.text(a+" is presenting")),c=this.model.get("viewCount"),c=c?c+" views":"0",this.totalViews.text(c)},b}(Backbone.View),f=function(a){function b(){this.update=q(this.update,this),b.__super__.constructor.apply(this,arguments)}return s(b,a),b.prototype.initialize=function(){return this.model.bind("change",this.update)},b.prototype.update=function(){var a;return a=this.model.get("state"),a==="disconnected"?this.$el.show():this.$el.hide()},b}(Backbone.View),c=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return s(b,a),b.prototype.events={"click .mark-in":"markIn","click .mark-out":"markOut"},b.prototype.initialize=function(){return this.setElement($("#main-container")),this.connectionView=new f({el:$(".connection-view"),model:WWM.conn}),this.videoInfo=new l({el:this.el,model:WWM.models.video,usersModel:WWM.models.users}),this.playerView=new h.PlayerView({model:WWM.models.video}),this.rightSide=new j({el:this.$(".right-side")}),this.chatView=new e.View({el:this.$(".chat-view"),collection:WWM.models.chat}),$(window).blur(function(){var a,b;return a=WWM.models.users.filter(function(a){return a.get("id_user")===WWM.user._id}),a!=null&&(b=a[0])!=null&&b.save({idle:!0}),WWM.idle=!0}),$(window).focus(function(){var a,b;return a=WWM.models.users.filter(function(a){return a.get("id_user")===WWM.user._id}),a!=null&&(b=a[0])!=null&&b.save({idle:!1}),WWM.idle=!1}),this.editButtons={markIn:this.$(".mark-in"),markOut:this.$(".mark-out")},this.rightSide.render(),WWM.initialized=!0},b.prototype.markIn=function(){var a;if(!WWM.isModerator)return;return this.rightSide.selectBookmarks(),a=WWM.models.video.toJSON(),delete a._id,a.position=this.playerView.player.getCurrentTime(),this.lastPoint=WWM.models.bookmarks.create(a)},b.prototype.markOut=function(){var a,b,c;if(!WWM.isModerator)return;if(!this.lastPoint)return;this.rightSide.selectBookmarks(),c=this.lastPoint.get("position"),a=this.playerView.player.getCurrentTime(),b=a-c;if(b>0)return this.lastPoint.save({length:b}),this.lastPoint=null;return},b.prototype.show=function(){return this.$el.show(),this},b}(Backbone.View),WWM.bindEvents=function(){return WWM.models.playlist.bind("selected",function(a){var b;if(!WWM.isModerator)return;return b=a.toJSON(),console.log("Selected: ",b),delete b._id,WWM.models.video.set(b)}),WWM.models.users.bind("server-broadcast",WWM.models.chat.add),WWM.models.chat.bind("new-msg",WWM.models.users.broadcast),WWM.models.bookmarks.bind("selected",function(a){var b;if(!WWM.isModerator)return;return b=a.toJSON(),delete b._id,WWM.models.video.set(b)})},m=function(){var a,b;return b=document.createElement("script"),b.src="http://www.youtube.com/player_api",a=document.getElementsByTagName("script")[0],a.parentNode.insertBefore(b,a)},o=function(a){return WWM.models.video.set(a.video),WWM.models.users.reset(a.users),WWM.models.playlist.reset(a.playlist)},window.onYouTubePlayerAPIReady=function(){return WWM.conn=new n.ConnectionState,WWM.conn.bind("joined",function(a){var d,e,f;e=WWM.conn.sio.of(WWM.session._id),d=k.createClient(e),b("models").init(d,a),WWM.bindEvents();if(WWM.initialized)return;return((f=WWM.user.name)!=null?f.length:void 0)?(new c).show():g.show(function(a){return WWM.user.name=a.name,(new c).show()})}),WWM.conn.join(WWM.session.docid)},a.start=function(){return $(function(){return m()})}})).call(this)},bookmarks:function(a,b,c){((function(){var c,d,e,f,g,h,i=function(a,b){return function(){return a.apply(b,arguments)}},j=Object.prototype.hasOwnProperty,k=function(a,b){function d(){this.constructor=a}for(var c in b)j.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};typeof window!="undefined"&&window!==null&&(h=window.module)!=null&&h.enter("bookmarks"),g=b("utils"),f=function(a){var b,c,d,e,f;return d=Math.floor(a/3600),b=a%3600,e=Math.floor(b/60),c=b%60,a=Math.ceil(c),f={h:d,m:e,s:a}},d=function(a){function b(){this.render=i(this.render,this),this.removeItem=i(this.removeItem,this),b.__super__.constructor.apply(this,arguments)}return k(b,a),b.prototype.tagName="tr",b.prototype.className="play-item",b.prototype.events={click:"itemClicked","click .remove":"removeItem"},b.prototype.initialize=function(){var a=this;return this.template=g.loadTemplate("one-bookmark-item"),this.model.bind("change",this.render),this.model.bind("remove",function(){return a.remove()})},b.prototype.removeItem=function(a){return a.preventDefault(),this.model.destroy(),!1},b.prototype.itemClicked=function(){return this.model.trigger("selected",this.model)},b.prototype.modelData=function(){var a,b,c;return c=this.model.toJSON(),a=f(c.position),b=[],a.h>0&&b.push(a.h),b.push(a.m),b.push(a.s),c.startTime=b.join(":"),c},b.prototype.render=function(){return $(this.el).html(this.template(this.modelData())),this},b}(Backbone.View),c=function(a){function b(){this.render=i(this.render,this),this.addAll=i(this.addAll,this),this.addOne=i(this.addOne,this),b.__super__.constructor.apply(this,arguments)}return k(b,a),b.prototype.initialize=function(){return this.collection.bind("add",this.addOne),this.collection.bind("reset",this.addAll)},b.prototype.addOne=function(a){var b;return b=new d({model:a}),this.$el.append(b.render().el)},b.prototype.addAll=function(){return this.$el.empty(),this.collection.each(this.addOne)},b.prototype.render=function(){return this.addAll(),this},b}(Backbone.View),a.View=e=function(a){function b(){this.initialize=i(this.initialize,this),b.__super__.constructor.apply(this,arguments)}return k(b,a),b.prototype.initialize=function(){return this.bookmarks=new c({collection:this.collection,el:this.$(".bookmarks")}),this.bookmarks.addAll()},b}(Backbone.View)})).call(this)},chat:function(a,b,c){((function(){var c,d,e,f,g,h=function(a,b){return function(){return a.apply(b,arguments)}},i=Object.prototype.hasOwnProperty,j=function(a,b){function d(){this.constructor=a}for(var c in b)i.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};(g=window.module)!=null&&g.enter("chat"),f=b("utils"),e=function(a){function b(){this.render=h(this.render,this),b.__super__.constructor.apply(this,arguments)}return j(b,a),b.prototype.tagName="li",b.prototype.initialize=function(){return this.template=f.loadTemplate("one-chat-item"),this.model.bind("change",this.render)},b.prototype.render=function(){return this.$el.html(this.template(this.model.toJSON())),this},b}(Backbone.View),d=function(a){function b(){this.addOne=h(this.addOne,this),b.__super__.constructor.apply(this,arguments)}return j(b,a),b.prototype.initialize=function(){return this.collection.bind("add",this.addOne),this.collection.bind("reset",this.addAll)},b.prototype.addOne=function(a){var b;return b=new e({model:a}),this.$el.prepend(b.render().el)},b.prototype.addAll=function(a){return this.$el.empty(),this.collection.each(this.addOne)},b.prototype.render=function(){return this.addAll(),this},b}(Backbone.View),a.View=c=function(a){function b(){this.onChatKeyUp=h(this.onChatKeyUp,this),b.__super__.constructor.apply(this,arguments)}return j(b,a),b.prototype.events={"keyup input.chat-message":"onChatKeyUp"},b.prototype.initialize=function(){return this.messages=new d({el:this.$(".messages"),collection:this.collection}),this.chatInput=this.$("[name=chat-message]"),this.messages.render()},b.prototype.resizeLayout=function(){},b.prototype.onChatKeyUp=function(a){var b,c;if(a.keyCode===13){c=$.trim(this.chatInput.val());if(!c.length)return;return b={from:WWM.user.name,message:c},this.collection.trigger("new-msg",b),b.message=_.escape(c),this.collection.add(b),this.chatInput.val("")}},b}(Backbone.View)})).call(this)},index:function(a,b,c){((function(){var a,c;c=b("utils"),a=function(a){var b;return b=$(".err-message"),$(".alert",b).text(a),b.removeClass("hidden")},{hideError:function(){return $(".err-message").addClass("hidden")}},$(function(){var b;return b=$("[name=url]"),$(".you").submit(function(d){var e,f;return e=b.val(),c.isYoutubeUrl(e)||(a("Not a valid youtube URL"),d.preventDefault(),!1),f=c.extractVideoId(e),$.getJSON("https://gdata.youtube.com/feeds/api/videos/"+f+"?v=2&alt=jsonc&callback=?",function(b,d){var f;if(d==="success"&&!b.error)return f=c.extractItemAttributes(b.data),f.url=e,$.post("/createSession",f,function(b,c){return(b!=null?b.sessionId:void 0)?window.location="/w/"+b.sessionId:a("Error fetching video details: ",b.error)})}),d.preventDefault(),!1}),b.keyup(function(){var a;a=b.val();if(c.isYoutubeUrl(a))return $(".err-message").addClass("hidden")})})})).call(this)},ioState:function(a,b,c){((function(){var b,c=Object.prototype.hasOwnProperty,d=function(a,b){function e(){this.constructor=a}for(var d in b)c.call(b,d)&&(a[d]=b[d]);return e.prototype=b.prototype,a.prototype=new e,a.__super__=b.prototype,a};(b=window.module)!=null&&b.enter("ioState"),a.ConnectionState=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return d(b,a),b.prototype.setState=function(a,b){return this.set({state:a,message:b})},b.prototype.join=function(a){var b=this;return this.setState("connecting"),this.sio=io.connect(),this.sio.socket.on("error",function(a){return b.setState("error",a)}),this.sio.on("connect",function(){return b.setState("loading"),b.sio.emit("join",a,function(a,c){return a?b.setState("error",a):(b.setState("connected"),b.trigger("joined",c))})}),this.sio.on("disconnect",function(){return b.set({state:"disconnected"})})},b}(Backbone.Model)})).call(this)},models:function(a,b,c){((function(){var b,c,d,e,f,g,h,i,j,k=Object.prototype.hasOwnProperty,l=function(a,b){function d(){this.constructor=a}for(var c in b)k.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};typeof window!="undefined"&&window!==null&&(j=window.module)!=null&&j.enter("models"),Backbone.Model.prototype.idAttribute="_id",e=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return l(b,a),b}(Backbone.Model),d=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return l(b,a),b.prototype.model=e,b}(Backbone.Collection),i=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return l(b,a),b.prototype.url="/video",b}(Skull.Model),h=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return l(b,a),b.prototype.url="/users",b}(Skull.Collection),b=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return l(b,a),b.prototype.defaults={id_session:0,videoId:"",start:0,length:0},b}(Skull.Model),c=function(a){function c(){c.__super__.constructor.apply(this,arguments)}return l(c,a),c.prototype.url="/bookmarks",c.prototype.model=b,c}(Skull.Collection),f=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return l(b,a),b.prototype.defaults={url:"",thumbnail:"",position:0,uploader:"dj sample",viewCount:345,paused:!1,votes:0,voters:null},b}(Skull.Model),g=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return l(b,a),b.prototype.model=f,b.prototype.url="/playlist",b.prototype.comparator=function(a){var b,c,d;return b=(c=(d=a.get("voters"))!=null?d.length:void 0)!=null?c:0,-b},b}(Skull.Collection),a.init=function(a,b){var e,f,j,k,l;return e=(f=WWM.models)!=null?f:WWM.models={},((j=e.video)!=null?j:e.video=a.addModel(new i)).set(b.video),((k=e.users)!=null?k:e.users=a.addModel(new h)).reset(b.users),((l=e.playlist)!=null?l:e.playlist=a.addModel(new g)).reset(b.playlist),e.chat==null&&(e.chat=new d),(e.bookmarks=a.addModel(new c)).reset(b.bookmarks),e}})).call(this)},"name-dialog":function(a,b,c){((function(){var b,c,d,e,f=Object.prototype.hasOwnProperty,g=function(a,b){function d(){this.constructor=a}for(var c in b)f.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new 
d,a.__super__=b.prototype,a},h=function(a,b){return function(){return a.apply(b,arguments)}};(e=window.module)!=null&&e.enter("name-dialog"),c=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return g(b,a),b}(Backbone.Model),b=function(a){function b(){this.submitForm=h(this.submitForm,this),b.__super__.constructor.apply(this,arguments)}return g(b,a),b.prototype.initialize=function(){var a=this;return this.setElement($("#name-dialog")),this.input=this.$("[name=user-name]"),this.input.keyup(function(b){if(b.keyCode===13)return a.submitForm()}),this.$(".btn.primary").click(function(a){return console.log("Clicked")})},b.prototype.submitForm=function(){var a,b=this;a=_.escape($.trim(this.input.val()));if(!a.length)return;return $.post("/setName",{name:a},function(c,d){return b.model.set({name:a}),typeof b.callback=="function"&&b.callback(b.model.toJSON()),b.$el.modal("hide")})},b.prototype.render=function(){return this},b.prototype.show=function(a){return this.callback=a,this.$el.show().modal({backdrop:"static",keyboard:!1}),this.$("input").focus()},b}(Backbone.View),d=null,a.show=function(a){return d?d.show(a):(d=new b({model:new c}),d.show(a))}})).call(this)},playerView:function(a,b,c){((function(){var c,d,e,f=function(a,b){return function(){return a.apply(b,arguments)}},g=Object.prototype.hasOwnProperty,h=function(a,b){function d(){this.constructor=a}for(var c in b)g.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};(e=window.module)!=null&&e.enter("playerView"),c=b("utils"),d=b("yt"),a.PlayerView=function(a){function b(){this.seek=f(this.seek,this),this.onShow=f(this.onShow,this),this.changeUrl=f(this.changeUrl,this),this.pausedChanged=f(this.pausedChanged,this),this.saveState=f(this.saveState,this),this.delaySaveState=f(this.delaySaveState,this),b.__super__.constructor.apply(this,arguments)}return h(b,a),b.prototype.initialize=function(){var a=this;return this.model.bind("change:url",this.changeUrl),this.model.bind("change:position",this.seek),this.model.bind("change:paused",this.pausedChanged),this.player=new d.Player({controls:WWM.isModerator}),this.player.state.bind("ready",function(){return a.changeUrl()}),this.st=0,this.player.insertPlayer(),this.player.bind("playing",function(){return console.log("~ Playing"),a.delaySaveState()}),this.player.bind("paused",function(){return console.log("~ Paused"),a.delaySaveState()}),this.player.bind("seeked",function(){return console.log("~ Seeked"),a.delaySaveState()})},b.prototype.delaySaveState=function(){clearTimeout(this.st);if(WWM.isModerator)return this.st=_.delay(this.saveState,150)},b.prototype.saveState=function(){var a;if(this.changingURL)return;return a={paused:this.player.isPaused(),position:this.player.getCurrentTime(),url:this.player.getVideoUrl()},console.log("*Saving state: ",a),this.model.save(a,{silent:!0})},b.prototype.pausedChanged=function(){if(this.model.get("paused")){if(!this.player.isPaused())return this.player.pauseVideo()}else if(!this.player.isPlaying()||!!WWM.idle)return this.player.playVideo()},b.prototype.changeUrl=function(){var a;console.log("Change URL: "+this.model.get("url")+" -> "+this.model.get("position")),a=c.extractVideoId(this.model.get("url"));if(a)return this.changingURL=!0,this.player.cueVideoById(a,this.model.get("position")),this.seek(),this.model.get("paused")&&this.player.pauseVideo(),this.changingURL=!1},b.prototype.onShow=function(){return this.seek()},b.prototype.seek=function(){if(WWM.idle)return;return this.player.seekTo(this.model.get("position"),!0)},b}(Backbone.View)})).call(this)},playlist:function(a,b,c){((function(){var c,d,e,f,g,h=function(a,b){return function(){return a.apply(b,arguments)}},i=Object.prototype.hasOwnProperty,j=function(a,b){function d(){this.constructor=a}for(var c in b)i.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};typeof window!="undefined"&&window!==null&&(g=window.module)!=null&&g.enter("playlist"),f=b("utils"),e=b("search"),c=function(a){function b(){this.render=h(this.render,this),this.thumbnailClicked=h(this.thumbnailClicked,this),this.removeItem=h(this.removeItem,this),b.__super__.constructor.apply(this,arguments)}return j(b,a),b.prototype.tagName="tr",b.prototype.className="play-item",b.prototype.events={"click .thumbnail":"thumbnailClicked",click:"itemClicked","click .remove":"removeItem"},b.prototype.initialize=function(){var a=this;return this.template=f.loadTemplate("one-play-item"),this.model.bind("change",this.render),this.model.bind("remove",function(){return a.remove()})},b.prototype.removeItem=function(a){return a.preventDefault(),this.model.destroy(),!1},b.prototype.thumbnailClicked=function(a){var b,c,d,e;return a.preventDefault(),c=WWM.user._id,b=(d=(e=this.model.get("voters"))!=null?e.slice():void 0)!=null?d:new Array,b.indexOf(c)!==-1?!1:(b.push(c),this.model.save({voters:b}),this.model.trigger("votes-changed",this.model),!1)},b.prototype.itemClicked=function(){return this.model.trigger("selected",this.model)},b.prototype.render=function(){return $(this.el).html(this.template(this.model.toJSON())),this},b}(Backbone.View),d=function(a){function b(){this.render=h(this.render,this),this.addAll=h(this.addAll,this),this.addOne=h(this.addOne,this),b.__super__.constructor.apply(this,arguments)}return j(b,a),b.prototype.initialize=function(){return this.collection.bind("add",this.addOne),this.collection.bind("reset",this.addAll),this.collection.bind("change:voters",this.collection.sort)},b.prototype.addOne=function(a){var b;return b=new c({model:a}),this.$el.append(b.render().el)},b.prototype.addAll=function(){return this.$el.empty(),this.collection.each(this.addOne)},b.prototype.render=function(){return this.addAll(),this},b}(Backbone.View),a.View=function(a){function b(){this.render=h(this.render,this),b.__super__.constructor.apply(this,arguments)}return j(b,a),b.prototype.initialize=function(){var a=this;return this.thumbnails=new d({el:this.$(".playlist"),collection:this.collection}),this.search=new e.View({el:this.$(".search-view")}),this.search.bind("selected",function(b){return a.collection.create({thumbnail:b.get("thumbnail"),title:b.get("title"),url:"http://www.youtube.com/watch?v="+b.get("videoId"),uploader:b.get("uploader"),viewCount:b.get("viewCount"),position:0,paused:!1})})},b.prototype.render=function(){return this.thumbnails.render(),this},b}(Backbone.View)})).call(this)},search:function(a,b,c){((function(){var c,d,e,f,g,h,i=Object.prototype.hasOwnProperty,j=function(a,b){function d(){this.constructor=a}for(var c in b)i.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a},k=function(a,b){return function(){return a.apply(b,arguments)}};typeof window!="undefined"&&window!==null&&(h=window.module)!=null&&h.enter("search"),g=b("utils"),c=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return j(b,a),b}(Backbone.Model),e=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return j(b,a),b.prototype.model=c,b}(Backbone.Collection),d=function(a){function b(){this.render=k(this.render,this),b.__super__.constructor.apply(this,arguments)}return j(b,a),b.prototype.tagName="tr",b.prototype.className="search-item",b.prototype.initialize=function(){return this.template=g.loadTemplate("one-search-item"),this.model.bind("change",this.render)},b.prototype.render=function(){return $(this.el).html(this.template(this.model.toJSON())),$(this.el).attr("id_model",this.model.get("videoId")),this},b}(Backbone.View),a.View=f=function(a){function b(){this.addAll=k(this.addAll,this),this.addOne=k(this.addOne,this),this.performSearch=k(this.performSearch,this),this.showSearchResults=k(this.showSearchResults,this),this.oninputkeyup=k(this.oninputkeyup,this),this.onclickselected=k(this.onclickselected,this),this.onkeyup=k(this.onkeyup,this),b.__super__.constructor.apply(this,arguments)}return j(b,a),b.prototype.OneItemView=d,b.prototype.events={"keyup input":"oninputkeyup","mouseover tr":"onmouseover","mouseout tr":"onmouseout","click tr":"onclickselected",keyup:"onkeyup"},b.prototype.initialize=function(){var a=this;return this.domEl&&(this.el=$($(this.domEl).html())),this.collection=new e,this.collection.bind("add",this.addOne),this.collection.bind("reset",this.addAll),this.searchResults=this.$(".search-place"),this.items=$(".search-results",this.searchResults),this.input=this.$(".search-video"),this.searchTimer=0,$(document).bind("click",function(b){if($(b.target).is("input.search-video"))return;return a.searchResults.hide()}),this.input.focus(function(b){return a.showSearchResults()})},b.prototype.onmouseover=function(a){return $(a.currentTarget).addClass("selected")},b.prototype.onmouseout=function(a){return $(a.currentTarget).removeClass("selected")},b.prototype.onkeyup=function(a){a.keyCode===27&&(this.searchResults.hide(),!1);if(a.keyCode===13)return this.onclickselected(),!1},b.prototype.onclickselected=function(){var a,b;return a=this.getSelected().attr("id_model"),b=this.collection.find(function(b){return b.get("videoId")===a}),this.trigger("selected",b),this.searchResults.hide()},b.prototype.getSelected=function(){var a;return a=this.$(".selected"),a.length===0&&(a=this.$("li:first")),a},b.prototype.selectNext=function(){var a,b;if(!(a=this.getSelected()))return;return b=a.next(),b.length===0&&(b=this.$("li:first")),a.removeClass("selected"),b.addClass("selected")},b.prototype.selectPrev=function(){var a,b;if(!(a=this.getSelected()))return;return b=a.prev(),b.length===0&&(b=this.$("li:last")),a.removeClass("selected"),b.addClass("selected")},b.prototype.oninputkeyup=function(a){var b;return a.keyCode===38?(this.selectPrev(),a.preventDefault(),a.stopPropagation(),!1):a.keyCode===40?(this.selectNext(),a.preventDefault(),a.stopPropagation(),!1):(b=$.trim(this.input.val()),b.length>3?b!==this.lastText?(this.lastText=b,clearTimeout(this.searchTimer),this.searchTimer=setTimeout(this.performSearch,750)):this.showSearchResults():this.searchResults.hide())},b.prototype.extractAttributes=function(a){var b;return b={thumbnail:a.thumbnail.sqDefault,title:a.title,viewCount:a.viewCount,uploader:a.uploader,url:a.url,videoId:a.id},b},b.prototype.showSearchResults=function(){var a,b,c;if(!this.collection.length)return;return this.searchResults.show(),c=this.searchResults.offset().top,a=$(window).innerHeight(),b=Math.min(this.items.height(),a-c-10),this.searchResults.height(b)},b.prototype.performSearch=function(){var a,b,c=this;a=$.trim(this.input.val());if(!a.length)return;return this.collection.reset(),g.isYoutubeUrl(a)?(b=g.extractVideoId(a),$.getJSON("https://gdata.youtube.com/feeds/api/videos/"+b+"?v=2&alt=jsonc&callback=?",function(a,b){return b==="success"?(c.collection.reset([c.extractAttributes(a.data)]),c.showSearchResults()):(console.log("Cannot get video info"),c.searchResults.hide())})):$.getJSON("https://gdata.youtube.com/feeds/api/videos?q="+a+"&v=2&alt=jsonc&callback=?",function(a,b){var d,e,f,g,h;return b==="success"&&(a!=null?(h=a.data)!=null?h.totalItems:void 0:void 0)?(f=function(){var b,c,d,f;d=a.data.items,f=[];for(b=0,c=d.length;b<c;b++)e=d[b],f.push(this.extractAttributes(e));return f}.call(c),d=function(a,b){return a+b.viewCount},g=_.reduce(a.data.items,d,0),console.log("Total Views: ",g),c.collection.reset(f),c.showSearchResults()):(console.log("Nothing found"),c.searchResults.hide())})},b.prototype.addOne=function(a){var b;return b=new this.OneItemView({model:a}),this.items.append(b.render().el)},b.prototype.addAll=function(){return this.items.empty(),this.collection.each(this.addOne)},b.prototype.render=function(){return this},b}(Backbone.View),a.createView=function(a){return new f({el:a})}})).call(this)},"skull-client":function(a,b,c){((function(){var b,c,d,e,f,g,h=function(a,b){return function(){return a.apply(b,arguments)}},i=Object.prototype.hasOwnProperty,j=function(a,b){function d(){this.constructor=a}for(var c in b)i.call(b,c)&&(a[c]=b[c]);return d.prototype=b.prototype,a.prototype=new d,a.__super__=b.prototype,a};(g=window.module)!=null&&g.enter("skull"),window.Skull={},Skull.isValidModel=function(a){return typeof a=="object"&&(a instanceof Skull.Model||a instanceof Skull.Collection)},e=function(a,b,c){var d;if(!b||!a)return;return d=b.sid===a.sid(),a.isLockedByMe=d,a.isLocked=!0,a.lockinfo=b,a.trigger("locked",d,b)},f=function(a,b){if(!a)return;return a.isLocked=!1,a.isLockedByMe=!1,delete a.lockinfo,a.trigger("unlocked")},c=function(){function a(a,b){this.model=a,this.name=b;if(!this.model instanceof Skull.Model)throw"Skull.Model expected"}return a.prototype.create=function(a){var b;return(b=this.model.collection)!=null?b.create(a):void 0},a.prototype.update=function(a){return this.model.set(a)},a.prototype["delete"]=function(){return this.model.destroy()},a.prototype.lock=function(a){return e(this.model,a)},a.prototype.unlock=function(a){return f(this.model,a)},a.prototype.broadcast=function(a){return this.model.trigger("server-broadcast",a)},a}(),b=function(){function a(a,b){this.collection=a,this.name=b;if(!this.collection instanceof Skull.Collection)throw"Skull.Collection expected"}return a.prototype.create=function(a){var b,c;b=a[Backbone.Model.prototype.idAttribute];if(b){c=this.collection.get(b);if(c){c.set(a);return}}return this.collection.add(a)},a.prototype.update=function(a){var b,c;return b=a[Backbone.Model.prototype.idAttribute],b&&(c=this.collection.get(b)),c!=null?c.set(a):void 0},a.prototype["delete"]=function(a){var b,c;b=a[Backbone.Model.prototype.idAttribute],b&&(c=this.collection.get(b));if(c)return this.collection.remove(c)},a.prototype.lock=function(a){var b,c;b=a[Backbone.Model.prototype.idAttribute],b&&(c=this.collection.get(b));if(c)return e(c,a)},a.prototype.unlock=function(a){var b,c;b=a[Backbone.Model.prototype.idAttribute],b&&(c=this.collection.get(b));if(c)return f(c,a)},a.prototype.broadcast=function(a){return this.collection.trigger("server-broadcast",a)},a}(),d=function(){function a(a,b){var c,d,e,f;this.socket=a,this.clientName=b,this.sync=h(this.sync,this),this.models={},this.sid=this.socket.socket.sessionid,f=["create","update","delete","lock","unlock","broadcast"];for(d=0,e=f.length;d<e;d++)c=f[d],this.addHandler(c)}return a.prototype.addHandler=function(a){return this.socket.on(a,h(function(b,c){var d;return console.log("Skull: Socket %s, %s",a,b),d=this.models[b],d!=null?typeof d[a]=="function"?d[a](c):void 0:void 0},this))},a.prototype.addModel=function(a,d){var e;if(!Skull.isValidModel(a))throw"Skull.Model or Skull.Collection expected!";return a instanceof Skull.Collection?e=b:e=c,d==null&&(d=a.name()),a._skull=this,a.sync=this.sync,this.models[d]=new e(a,d),a},a.prototype.sync=function(a,b,c){var d,e,f,g;return e=(g=typeof b.name==="function"?b.name():void 0)!=null?g:typeof (f=b.collection).name=="function"?f.name():void 0,console.log("[Skull] %s: emit %s, %s",this.clientName,a,e),d=a==="read"?c.filter:void 0,d==null&&(d=b.toJSON()),this.socket.emit(a,e,d,function(a,d){return a===null?c.success(d):c.error(b)})},a}(),Skull.createClient=function(a){var b;return(b=Skull.clients)==null&&(Skull.clients={}),Skull.clients[a.name]=new d(a,a.name)},Skull.BackboneSync=Backbone.sync,Backbone.sync=function(a,b,c){var d,e,f,g;return d=(e=(f=b.sync)!=null?f:(g=b.collection)!=null?g.sync:void 0)!=null?e:Skull.BackboneSync,typeof d=="function"?d(a,b,c):void 0},Skull.Model=function(){function a(){a.__super__.constructor.apply(this,arguments)}return j(a,Backbone.Model),a.prototype.isLocked=!1,a.prototype.isLockedByMe=!1,a.prototype.name=function(){var a,b,c;return(a=(b=this.collection)!=null?b.url:void 0)!=null?a:(c=typeof this.url==="function"?this.url():void 0)!=null?c:this.url},a.prototype.setLockInfo=function(a){return e(this,a)},a.prototype.sid=function(){var a,b;return(a=(b=this._skull)!=null?b.sid:void 0)!=null?a:this.collection.sid()},a.prototype.addEmbedded=function(a,b){var c;return((c=this._skull)!=null?c:this.collection._skull).addModel(a,b)},a.prototype.skullEmit=function(){var a,b,c,d;return a=(b=(c=this._skull)!=null?c.socket:void 0)!=null?b:(d=this.collection._skull)!=null?d.socket:void 0,a!=null?a.emit.apply(a,arguments):void 0},a.prototype.tryLock=function(a,b){var c,d;return typeof a=="function"&&(b=a),c=h(function(a,c){return a===null?e(this,c):this.trigger("lock-failed",c),typeof b=="function"?b(a,c):void 0},this),d={},d[Backbone.Model.prototype.idAttribute]=this.id,d.sid=this.sid(),d.action=a,this.isLocked&&!this.isLockedByMe?c("failed",this.lockinfo):this.isLockedByMe?c(null,this.lockinfo):this.skullEmit("lock",this.name(),d,c)},a.prototype.unlock=function(a){var b,c;return c={},c[Backbone.Model.prototype.idAttribute]=this.id,c.sid=this.sid(),this.isLocked&&!this.isLockedByMe?typeof a=="function"?a("failed",c):void 0:(b=h(function(b,c){return f(this,c),typeof a=="function"?a(b,c):void 0},this),this.skullEmit("unlock",this.name(),c,b))},a.prototype.broadcast=function(a,b){return b==null&&(b=function(){}),this.skullEmit("broadcast",this.name(),a,b)},a.prototype.emitCommand=function(a,b,c){return c==null&&(c=function(){}),b==null&&(b={}),b._command=a,this.skullEmit("clientCommand",this.name(),b,c)},a}(),Skull.Collection=function(){function a(){a.__super__.constructor.apply(this,arguments)}return j(a,Backbone.Collection),a.prototype.model=Skull.Model,a.prototype.name=function(){return this.url},a.prototype.sid=function(){return this._skull.sid},a.prototype.addEmbedded=function(a,b){return this._skull.addModel(a,b)},a.prototype.setLockInfo=function(a){var b,c,d,f,g;if(!a)return;_.isArray(a)||(a=[a]),g=[];for(d=0,f=a.length;d<f;d++)b=a[d],c=this.get(b[Backbone.Model.idAttribute]),g.push(c?e(c,b):void 0);return g},a.prototype.broadcast=function(a,b){return b==null&&(b=function(){}),this._skull.socket.emit("broadcast",this.name(),a,b)},a.prototype.emitCommand=function(a,b,c){return c==null&&(c=function(){}),b==null&&(b={}),b._command=a,this._skull.socket.emit("clientCommand",this.name,b,c)},a}(),a&&(a.Model=Skull.Model,a.Collection=Skull.Collection,a.createClient=Skull.createClient)})).call(this)},utils:function(a,b,c){((function(){var b,c;typeof window!="undefined"&&window!==null&&(c=window.module)!=null&&c.enter("utils"),typeof _!="undefined"&&_!==null&&(_.templateSettings={escape:/\{\{(.+?)\}\}/g,interpolate:/\{\-\{(.+?)\}\}/g,evaluate:/\{\=\{(.+?)\}\}/g}),a.loadTemplate=function(a){return a=a[0]==="#"?a:"#"+a,_.template($(a).html())},a.unescapeString=b=function(a){return $("<div/>").html(a).text()},a.isYoutubeUrl=function(a){return a.match(/^http:\/\/(?:www\.)?youtube.com\/watch\?(?=.*v=(.{11}))/)},a.extractVideoId=function(a){var b;return(b=a.match(/v=(.{11})/))!=null?b[1]:void 0},a.extractItemAttributes=function(a){var b;return b={thumbnail:a.thumbnail.sqDefault,title:a.title,viewCount:a.viewCount,uploader:a.uploader,url:a.url,videoId:a.id},b}})).call(this)},yt:function(a,b,c){((function(){var b,c,d=Object.prototype.hasOwnProperty,e=function(a,b){function e(){this.constructor=a}for(var c in b)d.call(b,c)&&(a[c]=b[c]);return e.prototype=b.prototype,a.prototype=new e,a.__super__=b.prototype,a},f=function(a,b){return function(){return a.apply(b,arguments)}};(c=window.module)!=null&&c.enter("yt"),a.PlayerState=b=function(a){function b(){b.__super__.constructor.apply(this,arguments)}return e(b,a),b.prototype.defaults={ready:!1,state:0,error:""},b}(Backbone.Model),a.Player=function(a){function c(){this.isPlaying=f(this.isPlaying,this),this.isPaused=f(this.isPaused,this),this.marshall=f(this.marshall,this),c.__super__.constructor.apply(this,arguments)}return e(c,a),c.prototype.initialize=function(){var a;return this.state=new b,this.idPlayer=(a=this.options.idPlayer)!=null?a:"player",this.state.bind("change:ready",this.marshall)},c.prototype.marshall=function(){var a,b,c,d,e;d="cueVideoById\nloadVideoById\nseekTo\nplayVideo\npauseVideo\ngetPlayerState\ngetVideoUrl".split("\n"),e=[];for(b=0,c=d.length;b<c;b++)a=d[b],e.push(this[a]=_.bind(this.player[a],this.player));return e},c.prototype.isPaused=function(){return this.player.getPlayerState()===YT.PlayerState.PAUSED},c.prototype.isPlaying=function(){return this.player.getPlayerState()===YT.PlayerState.PLAYING},c.prototype.getCurrentTime=function(){return Math.round(this.player.getCurrentTime())},c.prototype.insertPlayer=function(){var a,b,c,d=this;return a=this.state,this.player=new YT.Player(this.idPlayer,{height:(b=this.options.height)!=null?b:390,width:(c=this.options.width)!=null?c:"100%",playerVars:{autoplay:0,controls:this.options.controls?"1":"0"},events:{onReady:function(){return a.set({ready:!0}),a.trigger("ready")},onStateChange:function(b){var c;c=a.get("state"),a.set({state:b.data});switch(b.data){case YT.PlayerState.PLAYING:return c===YT.PlayerState.PLAYING?d.trigger("seeked"):d.trigger("playing");case YT.PlayerState.PAUSED:return c===YT.PlayerState.PAUSED?d.trigger("seeked"):d.trigger("playing")}},onError:function(b){return a.set({error:function(){switch(b){case 2:return"Invalid parameters";case 100:return"Video not found";case 101:return"Video cannot be embedded";default:return"Unknown error"}}()})}}})},c}(Backbone.View)})).call(this)}});